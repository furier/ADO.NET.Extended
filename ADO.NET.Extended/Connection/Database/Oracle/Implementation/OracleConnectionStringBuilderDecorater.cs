...
// //////////////////////////////////////////////////////
// /// File: OracleConnectionStringBuilderDecorater.cs
...
{
    /// <summary>   Author: Sander Struijk Class OracleConnectionStringBuilderDecorater. </summary>
    /// <remarks>   Sander Struijk, 31.08.2013. </remarks>
    /// <seealso cref="T:ADO.NET.Extended.Connection.Database.Oracle.Interface.IOracleConnectionStringBuilderDecorater"/>
    public class OracleConnectionStringBuilderDecorater : IOracleConnectionStringBuilderDecorater
    {
        /// <summary>   The integrated security. </summary>
        private const string IntegratedSecurity = "Integrated Security";

        /// <summary>   The _oracle connection string builder. </summary>
        private readonly OracleConnectionStringBuilder _oracleConnectionStringBuilder;

        /// <summary>   The _integrated security used. </summary>
        private bool _integratedSecurityUsed;

        /// <summary>   Initializes a new instance of the <see cref="OracleConnectionStringBuilderDecorater" /> class. </summary>
        /// <remarks>   Sander Struijk, 31.08.2013. </remarks>
        ...
        public string UserName
        {
            ...
            set { if (!string.IsNullOrEmpty(value)) _oracleConnectionStringBuilder.UserID = value; }
        }
        ...
        public string Password
        {
            ...
            set { if (!string.IsNullOrEmpty(value)) _oracleConnectionStringBuilder.Password = value; }
        }
        ...
        /// <summary>   Sets the single sign on values. </summary>
        /// <remarks>   Sander Struijk, 31.08.2013. </remarks>
        ...
        private void SetSingleSignOnValues(bool value)
        {
            try
            {
                ...
                if (value)
                {
                    ...
                    if (!_oracleConnectionStringBuilder.ContainsKey(IntegratedSecurity)) _oracleConnectionStringBuilder.Add(IntegratedSecurity, "SSPI");
            ...
            else _oracleConnectionStringBuilder.UserID = "";
        }
    }
}