...
// // ***********************************************************************
// // <copyright file="OracleSqlCommandException.cs" company="Statoil">
...
namespace ADO.NET.Extended.Connection.Database.Oracle.OracleExceptions
{
    /// <summary>
    ///     Author: Sander Struijk
    ///     Class OracleSqlCommandException
    /// </summary>
    public class OracleSqlCommandException : Exception
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="OracleSqlCommandException" /> class.
        /// </summary>
